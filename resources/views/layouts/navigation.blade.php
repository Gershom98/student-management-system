<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Links za Admin na Mwalimu (Management) -->
                    ...
                    <x-nav-link :href="route('grades.report')" :active="request()->routeIs('grades.report')">
                        {{ __('Reports') }}
                    </x-nav-link>
                    @endif

                    <!-- Links za Mwanafunzi Pekee -->
                    ...
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>{{ Auth::user()->name }} <span
                                    class="text-xs text-gray-400">({{ ucfirst(Auth::user()->role) }})</span></div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Responsive Links za Admin/Teacher -->
            @if(Auth::user()->role === 'admin' || Auth::user()->role === 'teacher')
            ...
            <x-responsive-nav-link :href="route('grades.report')" :active="request()->routeIs('grades.report')">
                {{ __('Reports') }}
            </x-responsive-nav-link>
            @endif

            <!-- Responsive Links za Student -->
            @if(Auth::user()->role === 'student')
